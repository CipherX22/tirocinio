...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.jhipster.test.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.jhipster.test.security.DomainUserDetailsService", "createSpringSecurityUser");
